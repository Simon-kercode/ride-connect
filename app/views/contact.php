...
<main id="contactPage">
    <h1>Contact</h1>
    <p>Un problème ? Une question ? Laissez nous vous aider. Nous vous répondrons dans les meilleurs délais.</p>
    <form action="" method="POST">
        ...
        <div>
            <textarea name="contactMessage" id="contactMessage" cols="30" rows="10" placeholder="En quoi pouvons nous vous aider ?"></textarea>
