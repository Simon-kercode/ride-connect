...
<main id="orgaPage" class="container">
    ...
    <form action="" method="POST">
        ...
        <div>
            ...
            <input type="text" name="rdv" placeholder="ex: Station essence Leclerc Vannes">
        </div>
        <div>
            <label for="partNumber">Nombre maximum de participants (laisse ce champ vide si tu n'a pas de limites de nombre)</label>
